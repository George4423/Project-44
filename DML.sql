...
BEGIN
    ...
    -- Select unique cuisines ensuring no cuisine appears more than once
    cuisine_selection: WHILE i < 10 DO
        ...
        IF cuisine_count < 10 THEN
            ...
            IF v_cuisine IS NOT NULL THEN
                ...
                -- Ensure no cook appears more than once per episode and no more than three times in a row
    ...
    -- Select judges who are not cooks from the current episode
